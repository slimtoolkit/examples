# Python2 Flask Web Service on Alpine Linux

NOTE: Python/Flask apps require, at least, one HTTP call, so the app gets a chance to load the extra dependencies it needs.
