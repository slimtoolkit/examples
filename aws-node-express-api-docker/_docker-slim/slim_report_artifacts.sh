...
docker-slim --report $IMAGE_NAME.slim.report.json build --http-probe-cmd-file custom-probe.json --copy-meta-artifacts . --include-path-file includefile ${IMAGE_NAME}:${GIT_REVISION}
